            ...
            modelBuilder.Entity("OnlineStore.Models.Database.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 876, DateTimeKind.Local).AddTicks(6794),
                            CreatorUserId = 3,
                        ...
                        new
                        {
                            ...
                            CategoryId = 1,
                            CommentsEnabled = true,
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 876, DateTimeKind.Local).AddTicks(8280),
                            CreatorUserId = 3,
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CommentsEnabled = true,
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 876, DateTimeKind.Local).AddTicks(8356),
                            CreatorUserId = 3,
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CommentsEnabled = true,
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 876, DateTimeKind.Local).AddTicks(8362),
                            CreatorUserId = 3,
                            Description = "New notebook from Apple is already in our store.",
                            ImageId = 4,
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            CommentsEnabled = true,
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 876, DateTimeKind.Local).AddTicks(8365),
                            CreatorUserId = 3,
            ...
            modelBuilder.Entity("OnlineStore.Models.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Adress = "",
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 821, DateTimeKind.Local).AddTicks(1432),
...
�d�mq<�",
                        ...
                        new
                        {
                            Id = 2,
                            Adress = "",
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 875, DateTimeKind.Local).AddTicks(7863),
                        ...
                        new
                        {
                            Id = 3,
                            Adress = "",
                            CreationTime = new DateTime(2024, 6, 16, 15, 29, 33, 875, DateTimeKind.Local).AddTicks(8699),
